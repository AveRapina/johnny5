 ...
 */
extern bool i2cdevRead(int handle, uint8_t memAddress,
 ...
 * @return TRUE if read was successful, otherwise FALSE.
 */
extern bool i2cdevReadByte(int handle, uint8_t memAddress, uint8_t *data);
 ...
 * @return TRUE if read was successful, otherwise FALSE.
 */
extern bool i2cdevReadBit(int handle, uint8_t memAddress, uint8_t bitNum, uint8_t *data);
/**
 ...
 * @return TRUE if read was successful, otherwise FALSE.
 */
extern bool i2cdevReadBits(int handle, uint8_t memAddress,
 ...
 */
extern bool i2cdevWrite(int handle, uint8_t memAddress, uint16_t len, uint8_t *data);
 ...
 * @return TRUE if write was successful, otherwise FALSE.
 */
extern bool i2cdevWriteByte(int handle, uint8_t memAddress, uint8_t data);
 ...
 * @return TRUE if read was successful, otherwise FALSE.
 */
extern bool i2cdevWriteBit(int handle, uint8_t memAddress,
 ...
 * @return TRUE if read was successful, otherwise FALSE.
 */
extern bool i2cdevWriteBits(int handle, uint8_t memAddress,
                     uint8_t bitStart, uint8_t length, uint8_t data);
